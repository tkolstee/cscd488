...
@section('pagecontent')
    ...
    @endif
    @if ($step == 1)
        <h2>What is a Malvertising attack?</h2>
        ...
        reputable).</p>
        <h2>How does an advertising network work?</h2>
    ...
    @elseif ($step == 2)
        <h2>How do attackers attack using an ad?</h2>
        ...
        <ul><li>A Drive-by-Download: malware is installed when a user views the ads <br>
        possible due to browser vulnerabilities.</li>
        <li>A Forced Redirect to a Malicious Website</li>
        <li>Displaying malicious content by executing javascript</li></ul>
        <p>When users click on an ad it can cause: </p>
        <ul><li>Execution of code that installs malware/adware on the user's computer</li>
        <li>A redirect to a malicious website instead of advertised website</li>
        <li>A redirect to a fake website that looks real (phishing attack)</li></ul>
    @elseif ($step == 3)
        <h2>Other ways attackers can perform a Malvertising attack</h2>
    ...
    @elseif ($step == 4)
        <h2>Ways ad publishers can protect against Malvertising attacks</h2>
        <p>As an ad publisher, ways you can avoid hosting a malicious ad are:</p>
        <ul><li>Make sure the ad networks, delivery paths, <br>
         and security practices are good</li>
        <li>Scan the ad creative that is intended for the display <br>
        to make sure it is safe</li>
        <li>Filter the file type of ads to prevent Javascript <br>
        or other unwanted code</li></ul>
    @endif
